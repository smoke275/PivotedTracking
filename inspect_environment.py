...
if __name__ == "__main__":
    ...
    print("    Press Z to automatically enable F+O+B+Y features in one step.")
    print("    This activates agent-following, probability overlay, gaps, and rotating rods simultaneously.")
