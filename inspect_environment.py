...
if __name__ == "__main__":
    ...
    print("    J: Toggle probability overlay for second agent (cyan, 800px visibility circle)")
    print("       Equal probability for visible nodes, zero outside visibility circle")
    ...
    print("    Z: Auto-enable all rotating rods features (F+O+B+J+Y)")
    ...
    print("  Quick Start: Press Z to enable F+O+B+J+Y features in one step")
